export const Icons = {
  ...
  instagramFooter: {
    paths: [
      {
        d: "M7.5 2A5.5 5.5 0 002 7.5v9A5.5 5.5 0 007.5 22h9a5.5 5.5 0 005.5-5.5v-9A5.5 5.5 0 0016.5 2h-9zm0 1.5h9A4 4 0 0120.5 7v9a4 4 0 01-4 4h-9a4 4 0 01-4-4V7a4 4 0 014-4zm9.75 2.5a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5zM12 6.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zm0 1.5a4 4 0 110 8 4 4 0 010-8z",
      },
    ],
    class:
      "h-10 w-10 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
    viewBox: "0 0 24 24",
    fill: "currentColor",
    title: "Instagram",
  },
  whatsappFooter: {
    paths: [
      {
        d: "M12.04 2C6.486 2 2 6.486 2 12.043c0 1.887.496 3.726 1.44 5.345L2 22l4.72-1.221a9.96 9.96 0 0 0 5.32 1.505c5.554 0 10.04-4.486 10.04-10.041C22.08 6.486 17.594 2 12.04 2zm0 18.08c-1.592 0-3.151-.424-4.523-1.227l-.323-.188-2.8.724.75-2.732-.21-.343a8.01 8.01 0 0 1-1.135-4.272c0-4.425 3.604-8.04 8.041-8.04s8.041 3.615 8.041 8.04-3.604 8.04-8.041 8.04zm4.295-6.02c-.233-.12-1.379-.682-1.593-.76s-.37-.12-.527.12c-.157.24-.604.76-.74.92-.137.16-.273.18-.507.06-.233-.12-.985-.363-1.876-1.16-.693-.61-1.16-1.36-1.296-1.593-.137-.233-.014-.36.103-.478.106-.106.233-.273.353-.41.12-.137.16-.24.24-.397.08-.157.04-.3-.02-.42-.06-.12-.527-1.273-.72-1.74-.19-.454-.384-.393-.527-.4-.136-.006-.29-.008-.443-.008-.153 0-.4.06-.61.3-.21.24-.8.78-.8 1.9s.82 2.202.933 2.357c.113.155 1.613 2.463 3.91 3.45.547.236.975.377 1.31.483.55.175 1.05.15 1.448.09.44-.07 1.379-.563 1.573-1.106.193-.543.193-1.008.136-1.106-.056-.097-.21-.153-.443-.273z",
      },
    ],
    class:
      "h-10 w-10 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
